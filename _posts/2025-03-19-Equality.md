...
<ol>
  <li id="fn1"> Work by <a href="https://en.wikipedia.org/wiki/William_Alvin_Howard">Howard</a> and <a href="https://en.wikipedia.org/wiki/Nicolaas_Govert_de_Bruijn">de Bruijn</a> already introduces dependent typing, however, Martin-Löf is credited formalising dependent types into a coherent framework for constructive mathematics <a href="#ref1">↩</a></li>
</ol>

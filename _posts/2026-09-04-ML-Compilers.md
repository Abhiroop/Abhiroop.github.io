...
Today, I believe the world of machine learning compilers is living in its own "1960s Wild West" era. It is incredibly fragmented, and the chaos arises from every part of the pipeline: 
...
This landscape is a nightmare for compiler engineers to navigate. Before my PhD, I would be arrogant enough to say that I alone would be the one to unify this fragmented world into one uniform
...
3. [Setting up the monster that is MLIR](/mlc/mlirsetup) 
4. [Intro to MLIR with the Toy example](/mlc/mlirtoy) (🚧 Work in Progress)
